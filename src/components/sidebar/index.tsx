  ...
  return (
    <div className="flex flex-col w-full bg-muted/40">
        ...
        <TooltipProvider>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                href="#"
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text text-muted-foreground
                transition-colors hover:text-foreground"
              >
      ...
      <div className="sm:hidden flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <header
          className="sm:hidden sticky top-0 z-30 flex h-14 items-center px-4
            ...
            <SheetContent side="left" className="sm:max-w-xs">
              <nav className="grid gap-6 text-lg font-medium">
                ...
                <Link
                  ...
                  prefetch={false}
                >
                  <Home className="w-5 h- transition-all" />
                  Início
                </Link>
                <Link
                  href="#"
